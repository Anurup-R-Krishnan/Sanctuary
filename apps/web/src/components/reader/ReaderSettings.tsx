...
export default function ReaderSettings() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div>
        <h2 className="text-base font-semibold text-light-text dark:text-dark-text tracking-tight mb-6">Typography</h2>
      ...
      <div>
        <h2 className="text-base font-semibold text-light-text dark:text-dark-text tracking-tight mb-6">Display</h2>
        <div className="space-y-5">
