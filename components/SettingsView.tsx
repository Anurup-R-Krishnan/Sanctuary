...
const SettingsView: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 animate-[fadeInUp_0.5s_ease-out]">
      <h2 className="text-3xl font-serif font-bold text-light-text dark:text-dark-text">
        Settings
      </h2>
      ...
      <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-2xl shadow-soft-lg dark:shadow-dark-soft-lg">
        <h3 className="text-xl font-semibold font-serif mb-6 text-light-accent dark:text-dark-accent">
          Reading Preferences
        </h3>
        <div className="space-y-6">
          ...
          <div className="bg-light-primary dark:bg-dark-primary p-4 rounded-lg transition-all duration-300">
            ...
            >
              This is a live preview of your text settings. Adjust the sliders
              above to see the changes in real-time. The quick brown fox jumps
              over the lazy dog.
            </p>
          </div>
        </div>
      ...
      <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-2xl shadow-soft-lg dark:shadow-dark-soft-lg">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            >
              <span
                className={`inline-block w-4 h-4 transform bg-white rounded-full transition-transform duration-300 ${notifications ? "translate-x-6" : "translate-x-1"}`}
              />
            </button>
          </div>
          <div className="flex items-center justify-between">
            ...
            >
              <span
                className={`inline-block w-4 h-4 transform bg-white rounded-full transition-transform duration-300 translate-x-6`}
              />
            </button>
          </div>
          <button className="w-full text-left font-medium text-light-text dark:text-dark-text hover:bg-light-primary dark:hover:bg-dark-primary p-3 rounded-lg transition-colors">
            Manage Subscription
          </button>
          <button className="w-full text-left font-medium text-red-500 hover:bg-red-500/10 p-3 rounded-lg transition-colors">
            Sign Out
          </button>
        </div>
      </div>
