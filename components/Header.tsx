        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto gap-4">
          ...
          <div className="flex items-center gap-3 min-w-fit">
            <div className="relative">
              ...
              <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-light-accent to-amber-600 dark:from-dark-accent dark:to-amber-500 shadow-lg">
                <BookOpen className="w-5 h-5 text-white" />
              </div>
            </div>
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold tracking-tight text-light-text dark:text-dark-text">
                Sanctuary
              </h1>
              {isGuest && (
