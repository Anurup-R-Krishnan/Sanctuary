...
// .wrangler/tmp/bundle-vhyzWS/checked-fetch.js
...
// .wrangler/tmp/pages-oUsfUm/functionsWorker-0.3603697327582085.mjs
...
var defaultOptions = {
  ...
  factor: 2,
  shouldRetry: /* @__PURE__ */ __name2((_, iteration) => iteration < 5, "shouldRetry"),
  retryImmediately: false,
  jitter: true
};
var RETRY_IMMEDIATELY_DELAY = 100;
var sleep = /* @__PURE__ */ __name2(async (ms) => new Promise((s) => setTimeout(s, ms)), "sleep");
...
var isArrayString = /* @__PURE__ */ __name2((s) => {
...
__name2(normalizeGuestId, "normalizeGuestId");
...
__name2(resolveActor, "resolveActor");
...
__name2(listColumns, "listColumns");
...
__name2(getTableInfo, "getTableInfo");
...
__name2(ensureColumns, "ensureColumns");
...
__name2(hasPrimaryKeyColumn, "hasPrimaryKeyColumn");
...
__name2(ensureSessionsSchema, "ensureSessionsSchema");
...
__name2(ensureBooksSchema, "ensureBooksSchema");
...
__name2(ensureBooksSchemaOnce, "ensureBooksSchemaOnce");
...
__name2(createFallbackId, "createFallbackId");
...
__name2(toNonEmptyText, "toNonEmptyText");
function toOptionalText(value) {
  if (typeof value === "string" && value.trim().length > 0) return value.trim();
  return null;
}
__name(toOptionalText, "toOptionalText");
__name2(toOptionalText, "toOptionalText");
...
__name2(normalizeBookmarksJson, "normalizeBookmarksJson");
...
__name2(rebuildBooksTableCanonical, "rebuildBooksTableCanonical");
...
__name2(rebuildUserSettingsCanonical, "rebuildUserSettingsCanonical");
...
__name2(startOfUtcDay, "startOfUtcDay");
...
__name2(isoDateOnly, "isoDateOnly");
...
__name2(sumDurationSec, "sumDurationSec");
...
__name2(toFiniteNumber, "toFiniteNumber");
...
__name2(getBookCoverKey, "getBookCoverKey");
...
__name2(normalizeBookmarks, "normalizeBookmarks");
...
__name2(parseBookmarksJson, "parseBookmarksJson");
...
__name2(toIsoDateOrNull, "toIsoDateOrNull");
...
__name2(missingCoverPlaceholder, "missingCoverPlaceholder");
...
__name(getBookCoverKey2, "getBookCoverKey2");
__name2(getBookCoverKey2, "getBookCoverKey");
...
// .wrangler/tmp/bundle-vhyzWS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vhyzWS/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3603697327582085.js.map
